...
-- AddForeignKey
ALTER TABLE `session_participant` ADD CONSTRAINT `session_participant_session_id_fkey` FOREIGN KEY (`session_id`) REFERENCES `matching_session`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `session_review` ADD CONSTRAINT `session_review_session_id_fkey` FOREIGN KEY (`session_id`) REFERENCES `matching_session`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
