...
import { handleCheckEmail, handleLogin, handleRefreshToken, handleSignUp, handleVerifyEmail } from "./controllers/auth.controller.js";
...
app.post("/auth/verification-codes", validateEmail, handleVerifyEmail);
